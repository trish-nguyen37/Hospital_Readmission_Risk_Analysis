...
-- diag1 is a double, change to varcar --
...
-- Get rid of duplicate patient encounters --
...
-- Find minimum encounter ID (earliest encounter) --
...
-- 	Filter put people who can't be readdmited (dead or hospice) --
...
-- what does are overall readmissions look like? --
	-- over 30 days, under 30 days, not readmidded
SELECT
	readmitted, 
    COUNT(*) as encounter_count, 
...
-- Within each age who is carrying the most medication load? --
WITH patient_risk_base AS (
	SELECT 
...
-- Which diagnosis categories are driving readmissions above hospital wide average?--
